...
public class AuthenticationActivity extends BaseActivity implements View.OnClickListener, Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.client_id_input_layout = activityAuthenticationBinding.contentAuthenticate.clientIdInputLayout;
        this.access_code_input_layout = activityAuthenticationBinding.contentAuthenticate.accessCodeInputLayout;
